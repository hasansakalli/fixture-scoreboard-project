    ...
    <div v-if="isActive" class="table-responsive">
      <table class="table table-hover">
        ...
        <tbody>
          <tr
            id="tableScor"
            v-for="(result, index) in allMatches"
            :key="result"
          >
  ...
  methods: {
    ...
    scores() {
      ...
      this.competitions.forEach((result) => {
        ...
        scoreTable[teamA].p =
          scoreTable[teamA].w + scoreTable[teamA].d + scoreTable[teamA].l;
        scoreTable[teamB].p =
          scoreTable[teamB].w + scoreTable[teamB].d + scoreTable[teamB].l;
    ...
    sortBy() {
      ...
      this.allMatches.sort((a, b) =>
        (a.points == b.points) & (a.gd > b.gd) ? -1 : 1
      );
      this.allMatches.sort((a, b) =>
        (a.points == b.points) & (a.gd == b.gd) & (a.gf > b.gf) ? -1 : 1
      );
    },
    ...
    getundPost() {
      ...
      axios
        .patch(`/posts/${this.userIdLogin}/${this.fixtureName}.json`, {
    ...
    resetScorboard() {
      (this.isActive = false), (this.competitions = []);
      (this.allMatches = []), (this.scorboard = "Save und Show Scorboard");
    },
